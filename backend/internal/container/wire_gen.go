...
func InitializeContainer(db *database.DB, cfg *config.Config, logger *slog.Logger) (Container, error) {
	...
	resourceAccessService := providers.ProvideResourceAccessService(resourceAccessRepository, resourceLastAccessedRepository, workerPool, logger, cfg)
	...
	memoryServiceInterface := providers.ProvideMemoryService(memoryRepository, teamServiceInterface, authorizationServiceInterface, eventManager, logger, contentVersionServiceInterface, commentRepository, relationRepository)
	...
	freshnessServiceInterface := providers.ProvideFreshnessService(freshnessRuleRepository, resourceFreshnessRepository, teamFreshnessSettingsRepository, projectRepository, authorizationServiceInterface, logger)
	...
	schedulerRegistry := providers.ProvideSchedulerRegistry()
