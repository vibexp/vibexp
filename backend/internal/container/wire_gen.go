...
func InitializeContainer(db *database.DB, cfg *config.Config, logger *slog.Logger) (Container, error) {
	...
	artifactServiceInterface := providers.ProvideArtifactService(artifactRepository, teamServiceInterface, authorizationServiceInterface, eventManager, resourceUsageServiceInterface, logger, contentVersionServiceInterface)
	...
	blueprintServiceInterface := providers.ProvideBlueprintService(blueprintRepository, teamServiceInterface, authorizationServiceInterface, eventManager, resourceUsageServiceInterface, logger, contentVersionServiceInterface)
	...
	memoryServiceInterface := providers.ProvideMemoryService(memoryRepository, teamServiceInterface, authorizationServiceInterface, eventManager, logger, contentVersionServiceInterface)
