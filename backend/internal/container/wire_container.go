...
func (c *WireContainer) TeamSettingsAuditService() services.TeamSettingsAuditServiceInterface {
	return c.teamSettingsAuditService
}
...
func (c *WireContainer) RelationSeedService() services.RelationSeedServiceInterface {
