...
var ProviderSet = wire.NewSet(
	...
	wire.Struct(new(services.MemoryServiceDeps), "*"),
	wire.Struct(new(services.GitHubAppServiceDeps), "*"),
	...
	wire.Bind(new(services.LLMCompleter), new(*services.LLMService)),
	...
	wire.Bind(new(services.Searcher), new(*services.SearchService)),
	wire.Bind(new(services.SourceDocumentSearcher), new(*services.SearchService)),
	providers.ProvideSearchSummaryService,
