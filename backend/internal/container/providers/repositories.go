...
// ProvideTeamEmailProviderRepository creates a new TeamEmailProviderRepository
func ProvideTeamEmailProviderRepository(db *database.DB) repositories.TeamEmailProviderRepository {
