...
// ReconcileSchedules provides a mock function with given fields: ctx
func (_m *MockFreshnessServiceInterface) ReconcileSchedules(ctx context.Context) error {
	ret := _m.Called(ctx)

	if len(ret) == 0 {
		panic("no return value specified for ReconcileSchedules")
	}
...
// MockFreshnessServiceInterface_ReconcileSchedules_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'ReconcileSchedules'
type MockFreshnessServiceInterface_ReconcileSchedules_Call struct {
	*mock.Call
}

// ReconcileSchedules is a helper method to define mock.On call
//   - ctx context.Context
func (_e *MockFreshnessServiceInterface_Expecter) ReconcileSchedules(ctx interface{}) *MockFreshnessServiceInterface_ReconcileSchedules_Call {
	return &MockFreshnessServiceInterface_ReconcileSchedules_Call{Call: _e.mock.On("ReconcileSchedules", ctx)}
}

func (_c *MockFreshnessServiceInterface_ReconcileSchedules_Call) Run(run func(ctx context.Context)) *MockFreshnessServiceInterface_ReconcileSchedules_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *MockFreshnessServiceInterface_ReconcileSchedules_Call) Return(_a0 error) *MockFreshnessServiceInterface_ReconcileSchedules_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *MockFreshnessServiceInterface_ReconcileSchedules_Call) RunAndReturn(run func(context.Context) error) *MockFreshnessServiceInterface_ReconcileSchedules_Call {
	_c.Call.Return(run)
	return _c
}
