...
// CreateGitHubAppConfigRequest is the payload for registering a team's App. All
// three secrets are required on create; UpdateGitHubAppConfigRequest is what
// allows partial edits.
type CreateGitHubAppConfigRequest struct {
	...
	// #nosec G117 - Request struct field for webhook secret input, not a hardcoded secret
