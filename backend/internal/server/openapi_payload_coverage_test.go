...
var payloadCoverageLedger = map[string]string{
	...
	"DELETE /api/v1/{team_id}/embedding-providers/{id}":               "TODO(#1714): uncovered",
	"DELETE /api/v1/settings/api-keys/{id}":                           "TODO(#1714): uncovered",
	"DELETE /api/v1/{team_id}/settings/embedding-providers/{id}":      "TODO(#1714): uncovered",
	...
	"POST /api/v1/{team_id}/embedding-providers":                      "TODO(#1714): uncovered",
	"POST /api/v1/{team_id}/embedding-providers/validate":             "TODO(#1714): uncovered",
	"POST /api/v1/prompt-gallery/prompts/{id}/use":                    "TODO(#1714): uncovered",
	"POST /api/v1/settings/api-keys":                                  "TODO(#1714): uncovered",
	"POST /api/v1/{team_id}/settings/embedding-providers":             "TODO(#1714): uncovered",
	"POST /api/v1/{team_id}/settings/embedding-providers/validate":    "TODO(#1714): uncovered",
	...
	"PUT /api/v1/{team_id}/embedding-providers/{id}":                  "TODO(#1714): uncovered",
	"PUT /api/v1/preferences":                                         "TODO(#1714): uncovered",
	"PUT /api/v1/{team_id}/settings/embedding-providers/{id}":         "TODO(#1714): uncovered",
