...
var adHocRequiredArrayAllowlist = map[string]string{
	...
	"FreshnessOverTimeMetricsData":        "generated strict-server type (internal/server/gen/freshness); handler builds counts via make(...,0) — handlers_freshness_metrics.go GetFreshnessOverTimeMetrics",
	"FreshnessByTypeMetricsData":          "generated strict-server type (internal/server/gen/freshness); handler builds counts via make(...,0) — handlers_freshness_metrics.go GetFreshnessByTypeMetrics",
	"FreshnessByProjectMetricsData":       "generated strict-server type (internal/server/gen/freshness); handler builds counts via make(...,0) — handlers_freshness_metrics.go GetFreshnessByProjectMetrics",
	"FreshnessByRuleMetricsData":          "generated strict-server type (internal/server/gen/freshness); handler builds counts via make(...,0) — handlers_freshness_metrics.go GetFreshnessByRuleMetrics",
	...
	"TeamSettingsAuditListResponse":       "generated strict-server type (internal/server/gen/teamsettings); handler builds entries via make(...,0) — handlers_team_settings_audit.go ListTeamSettingsAudit",
	...
	"AdminDashboardOverview":              "generated strict-server type (internal/server/gen/admin); handler builds breakdowns via make(...,0) — handlers_admin_dashboard.go toGenAdminOverview",
	...
	"AdminTeamFreshnessConfig":            "generated strict-server type (internal/server/gen/admin); rules built via make(...,0) — handlers_admin_project_analytics.go toGenAdminFreshnessRules",
	"AdminFreshnessRule":                  "generated strict-server type (internal/server/gen/admin); resource_types/mediums copied through nonNilStrings — handlers_admin_team_config.go toGenAdminFreshnessRule",
	"AdminTeamArtifactTypes":              "generated strict-server type (internal/server/gen/admin); handler builds types via make(...,0) — handlers_admin_team_config.go GetAdminTeamArtifactTypes",
	"AdminTeamSettingsAuditListResponse":  "generated strict-server type (internal/server/gen/admin); handler builds entries via make(...,0) — handlers_admin_team_config.go ListAdminTeamSettingsAudit",
	"AdminTeamModelProvidersConfig":       "generated strict-server type (internal/server/gen/admin); handler builds providers via make(...,0) — handlers_admin_team_config_providers.go GetAdminTeamModelProviders",
	"AdminModelProvider":                  "generated strict-server type (internal/server/gen/admin); configuration_keys built via make(...,0) — handlers_admin_team_config_providers.go configurationKeys",
	"AdminTeamEmbeddingProvidersConfig":   "generated strict-server type (internal/server/gen/admin); handler builds providers via make(...,0) — handlers_admin_team_config_providers.go GetAdminTeamEmbeddingProviders",
	"AdminEmbeddingProvider":              "generated strict-server type (internal/server/gen/admin); configuration_keys built via make(...,0) — handlers_admin_team_config_providers.go configurationKeys",
	"AdminEmbeddingCoverage":              "generated strict-server type (internal/server/gen/admin); items built via make(...,0) — handlers_admin_team_config_providers.go toGenAdminEmbeddingCoverage",
	...
	"AdminProjectListResponse":            "generated strict-server type (internal/server/gen/admin); handler builds projects via make(...,0) — handlers_admin_projects.go toGenAdminProjectList",
	"AdminUserInsights":                   "generated strict-server type (internal/server/gen/admin); handler builds teams via make(...,0) — handlers_admin_user_insights.go toGenAdminUserInsights",
	...
	"AdminUserAccessMetrics":              "generated strict-server type (internal/server/gen/admin); access_by_source built via make(...,0) — handlers_admin_project_analytics.go toGenAdminSourcePoints",
	...
	"AdminProjectAccessMetrics":           "generated strict-server type (internal/server/gen/admin); access_by_source built via make(...,0) — handlers_admin_project_analytics.go toGenAdminSourcePoints",
	"AdminProjectConfig":                  "generated strict-server type (internal/server/gen/admin); project_rules/team_wide_rules built via make(...,0) — handlers_admin_project_analytics.go toGenAdminFreshnessRules",
