...
var adHocRequiredArrayAllowlist = map[string]string{
	...
	"AdminTeamFreshnessConfig":           "generated strict-server type (internal/server/gen/admin); handler builds rules via make(...,0) — handlers_admin_team_config.go GetAdminTeamFreshnessConfig",
	...
	"AdminUserAccessMetrics":             "generated strict-server type (internal/server/gen/admin); handler builds access_by_source via make(...,0) — handlers_admin_user_access.go GetAdminUserResourceAccessMetrics",
