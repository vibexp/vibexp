...
var adHocRequiredArrayAllowlist = map[string]string{
	...
	"AdminTeamFreshnessConfig":            "generated strict-server type (internal/server/gen/admin); rules built via make(...,0) — handlers_admin_team_config.go toGenAdminFreshnessRules",
