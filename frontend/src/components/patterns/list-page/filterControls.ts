 ...
 * so a change lands on every list at once. The width itself is the
 * design-system `--control-width-sm` token (#921), mapped to `w-control-sm` in
 * the `@theme` block of `styles/index.css`.
 */
export const FILTER_CONTROL_WIDTH = 'w-control-sm'
