...
describe('PromptGallery page', () => {
  beforeEach(() => {
    vi.clearAllMocks()
    ;(promptGalleryService.getCategories as Mock).mockResolvedValue([])
  })

  it('shows a loading spinner while categories are in flight', () => {
    ;(promptGalleryService.getCategories as Mock).mockImplementation(
  ...
  it('surfaces a fetch failure through the alert context', async () => {
    ;(promptGalleryService.getCategories as Mock).mockRejectedValue(
