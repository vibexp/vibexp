...
/**
 * The agent card's own detail block. Card chrome removed in #918: the reading
 * shell's article is card-free, so this is a plain section with its heading.
 */
export function AgentCardDetails({ agent }: Readonly<AgentCardDetailsProps>) {
  ...
  return (
    <section className="space-y-6" aria-labelledby="agent-card-details-heading">
      <div className="flex items-center justify-between">
        <h3 id="agent-card-details-heading" className="text-lg font-semibold">
          Agent card details
        </h3>
        {agent.card_url && (
          <a
